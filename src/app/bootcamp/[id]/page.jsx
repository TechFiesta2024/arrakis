            ...
            <div className='md:px-20'>
                <div className="border-x-[.5px] border-yellowish">
                            ...
                            <div className="col-span-1 md:col-span-1 flex justify-center items-center border-r-[.5px] border-yellowish">
                                <div className='inline-flex gap-0 md:gap-2 py-4'>
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-yellowish text-xs md:text-base font-generalsans font-normal'>{bootcamp.timing}</h1>
                                    </div>
                                </div>
                            </div>
                            <div className="col-span-1 md:col-span-1 flex justify-center items-center border-r-[.5px] border-yellowish">
                                <div className='inline-flex gap-0 md:gap-2 py-4'>
                                    ...
                                    <div>
                                        ...
                                        <h1 className='text-yellowish text-xs md:text-base font-generalsans font-normal'>{bootcamp.mode} . {bootcamp.destination}</h1>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div className='pl-4 md:pl-14 border-y-[.5px] border-yellowish'>
                        <h1 className='text-yellowish font-generalsans font-semibold text-3xl md:text-5xl py-10'>Coordinators</h1>
                    </div>
