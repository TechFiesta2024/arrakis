...
export default function BootcampPage() {
    ...
    useEffect(() => {
        const filtered = bootcampData.filter(bootcamp => selectedButton === 'All' || bootcamp.type === selectedButton)
                    ...
                    <div className="flex justify-center items-center pt-20">
                        <div className="grid grid-cols-1">
                            <div className="flex-row">
                                ...
                                <span className="text-yellowish font-anton md:text-8xl px-2 mt-4 text-5xl">WORKSHOPS</span>
                                <span className="text-yellowish font-generalsans font-semibold md:text-8xl text-5xl">:</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="grid grid-cols-1">
                            <div className="flex-row justify-evenly items-center">
                                <button
                                    ...
                                    className={selectedButton === 'All' ? selectedBtnClass : btnClass}
                                >
                                    All
                                </button>
                                <button
                                    onClick={() => setSelectedButton('Software')}
                                    className={selectedButton === 'Software' ? selectedBtnClass : btnClass}
                                >
                                    Software
                                </button>
                                <button
                                    onClick={() => setSelectedButton('Hardware')}
                                    className={selectedButton === 'Hardware' ? selectedBtnClass : btnClass}
                                >
                                    Hardware
                                </button>
                            </div>
