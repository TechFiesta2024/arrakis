    ...
    return (
        <>
            <div className="prizeool-Badge_container bg-grid-pattern h-[100%] w-[100%] flex justify-center items-center">
                <div className="badge_div bg-yellowish h-[33%] w-[54.11%] rounded md:rounded-md lg:rounded-xl flex justify-between items-center gap-6 pl-2 pr-4 transition-transform hover:scale-110">
                    ...
                    <div className="text-black font-generalsans-semibold text-2xl flex-col items-end">
                        <span className="font-generalsans text-xs">🎉 Prizepool worth of</span>
                        <p>₹ 1,50,000</p>
                    </div>
                </div>
            </div>
