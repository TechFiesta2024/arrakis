    ...
    return (
        <>
            <div className="participate-badge_container bg-grid-pattern h-[100%] w-[100%] flex justify-center items-center">
                <div className="badge_div bg-yellowish h-[33%] w-[65.26%] rounded md:rounded-md lg:rounded-xl flex justify-center items-center gap-6">
                    <div className=" text-black font-generalsans-semibold text-lg">Participate</div>
                    <div className="">
